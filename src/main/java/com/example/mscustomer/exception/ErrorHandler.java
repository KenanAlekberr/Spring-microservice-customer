...
import static com.example.mscustomer.exception.ExceptionConstants.HTTP_METHOD_IS_NOT_CORRECT;
import static com.example.mscustomer.exception.ExceptionConstants.UNEXPECTED_EXCEPTION;
...
public class ErrorHandler {
    ...
    public ErrorResponse handle(NotFoundException exception) {
        ...
        return new ErrorResponse(CUSTOMER_NOT_FOUND.getCode(), CUSTOMER_NOT_FOUND.getMessage());
    }
}